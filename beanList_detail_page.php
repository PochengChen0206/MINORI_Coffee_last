    ...
    <div class="row">
        ...
        <div class="left-side">
            ...
            <div class="left-side-push100">
                <div class="hc-left-side-bg" style="background: url(./img/product_bean_left_001.jpg) no-repeat; background-size: cover;">
                    <!-- ======================================================================================= add content -->
                    <!-- head -->
                                ...
                                <div class="hc-products-detail-grp">
                                    <div class="hc-products-detail-control">
                                        <div class="hc-products-name">
                                            <h3 class="hc-name">耶加雪啡 晨之梅</h3>
                                        </div>
                                        <h4 class="hc-products-price">NT$300</h4>
                                        ...
                                        <div class="hc-products-content hc-products-bottomLine">
                                            ...
                                            <div class="hc-btn-grp">
                                                <div class="hc-products-list-grp hc-process-part2-grp d-flex">
                                                    ...
                                                    <div class="hc-process-control d-flex">
                                                        <button class="hc-process-btn hc-process-btn-active">半磅</button>
                                                        <button class="hc-process-btn hc-btn-push">一磅</button>
                                                        <button class="hc-process-btn">2.2磅</button>
                                                    </div>
                                                </div>
                                                <div class="hc-products-list-grp hc-process-part2-grp d-flex">
                                                    <div class="hc-products-list-secondTitle">
                                                    ...
                                                    <div class="hc-process-control d-flex">
                                                        <button class="hc-process-btn hc-process-btn-active">原豆</button>
                                                        <button class="hc-process-btn hc-btn-push">磨粉</button>
                                                    </div>
                                                </div>
                                                <div class="hc-products-list-grp hc-process-part2-grp d-flex">
                                                    <div class="hc-products-list-secondTitle">
